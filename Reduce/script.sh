...
echo
echo "Time takes to find min in array using 1 Thread & Granularity 1000"
./main.o 100000000 1 1000
echo "Time takes to find min in array using 2 Thread & Granularity 1000"
./main.o 100000000 2 1000
echo "Time takes to find min in array using 4 Thread & Granularity 1000"
./main.o 100000000 4 1000
echo "Time takes to find min in array using 8 Thread & Granularity 1000"
./main.o 100000000 8 1000
echo "Time takes to find min in array using 16 Thread & Granularity 1000"
./main.o 100000000 16 1000
echo
